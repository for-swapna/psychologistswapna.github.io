      ...
      <Container className="flex flex-wrap ">
        ...
        <div className="flex items-center lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-l leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              If you are facing issues for which you need counselling help, feel free to get in touch. I am running first 10 counselling sessions for free at the moment. 
            </p>
